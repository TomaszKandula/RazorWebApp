...
1. `Add-Migration -StartupProject SecureWebApp -Project SecureWebApp -Context MainDbContext -OutputDir Infrastructure\Database\Migrations <name>`
1. `Update-Database -StartupProject SecureWebApp -Project SecureWebApp -Context MainDbContext`

To remove migration:

1. `Remove-Migration -StartupProject SecureWebApp -Project SecureWebApp -Context MainDbContext`
